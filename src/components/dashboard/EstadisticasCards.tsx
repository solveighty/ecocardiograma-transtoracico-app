        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-3 place-items-center">
              <div className="w-full max-w-md text-center p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                {totalAnual > 0 && (
                  <span className="text-xs text-gray-500">
                    Máximo: {Math.max(...resumen.map((m) => m.total))}
                  </span>
                )}
              </div>
              ...
              <div className="space-y-2">
                {resumen.map((mes, index) => {
                  ...
                  const porcentaje =
                    totalAnual > 0
                      ? (mes.total / Math.max(...resumen.map((m) => m.total))) *
                        100
                      : 0;
                      ...
                      <div className="flex items-center justify-between mb-1">
                        <div
                          className={`text-xs font-medium ${
                            isCurrentMonth ? "text-purple-700" : "text-gray-600"
                          }`}
                        >
                          {mesNombre}
                          {isCurrentMonth && (
              ...
              {totalAnual === 0 && (
                <div className="text-center py-6">
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Los datos aparecerán cuando se registren exámenes
                  </p>
                </div>
              )}
            </div>
